...
#define NRF_PPIB00_NS_BASE NULL
#undef NRF_PPIB00_S_BASE
#define NRF_PPIB00_S_BASE NULL
#undef NRF_PPIB01_NS_BASE
#define NRF_PPIB01_NS_BASE NULL
#undef NRF_PPIB01_S_BASE
#define NRF_PPIB01_S_BASE NULL
#undef NRF_KMU_S_BASE
#define NRF_KMU_S_BASE NULL
...
#define NRF_PPIB10_NS_BASE NULL
#undef NRF_PPIB10_S_BASE
#define NRF_PPIB10_S_BASE NULL
#undef NRF_PPIB11_NS_BASE
#define NRF_PPIB11_NS_BASE NULL
#undef NRF_PPIB11_S_BASE
#define NRF_PPIB11_S_BASE NULL
...
#define NRF_PPIB20_NS_BASE NULL
#undef NRF_PPIB20_S_BASE
#define NRF_PPIB20_S_BASE NULL
#undef NRF_PPIB21_NS_BASE
#define NRF_PPIB21_NS_BASE NULL
#undef NRF_PPIB21_S_BASE
#define NRF_PPIB21_S_BASE NULL
#undef NRF_PPIB22_NS_BASE
#define NRF_PPIB22_NS_BASE NULL
#undef NRF_PPIB22_S_BASE
#define NRF_PPIB22_S_BASE NULL
...
#define NRF_PPIB30_NS_BASE NULL
#undef NRF_PPIB30_S_BASE
#define NRF_PPIB30_S_BASE NULL
